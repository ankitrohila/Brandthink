...
const SEED_FORMS: Form[] = [
  {
    ...
    fields: [
      { id: "f1", type: "text",     label: "Your Name",        placeholder: "Aditya Raj",              required: true  },
    ...
    settings: { submitText: "Send Message →", successMessage: "Thank you! We'll get back to you within 24 hours.", notifyEmail: "adityaraj@thebrandthink.com", active: true },
  ...
  },
  {
    ...
    settings: { submitText: "Subscribe", successMessage: "You're subscribed! Expect insights every week.", notifyEmail: "adityaraj@thebrandthink.com", active: true },
    createdAt: "2025-01-01T00:00:00Z",
    updatedAt: "2025-05-01T00:00:00Z",
    submissionsCount: 0,
    isBuiltIn: true,
  },
  {
    ...
    fields: [
      { id: "l1", type: "text",     label: "Your Name",     placeholder: "Aditya Raj",      required: true  },
    ...
    settings: { submitText: "Send Request", successMessage: "We've received your details and will reach out within 24 hours.", notifyEmail: "adityaraj@thebrandthink.com", active: true },
    createdAt: "2025-01-01T00:00:00Z",
    updatedAt: "2025-05-01T00:00:00Z",
    submissionsCount: 0,
    isBuiltIn: true,
  },
  {
    ...
    settings: { submitText: "Confirm Booking", successMessage: "Booking confirmed! Check your email for the Zoom link.", notifyEmail: "adityaraj@thebrandthink.com", active: true },
    createdAt: "2025-01-01T00:00:00Z",
    updatedAt: "2025-05-01T00:00:00Z",
    submissionsCount: 0,
    isBuiltIn: true,
