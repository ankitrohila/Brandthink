...
const SOCIALS = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/brand-think90/",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/brandthink__/",
    icon: (
  ...
  {
    label: "Twitter",
    href: "https://twitter.com/brandthink__",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/brandthink",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@brandthink",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
